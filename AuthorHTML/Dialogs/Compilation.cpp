...
BEGIN_MESSAGE_MAP(Compilation,CDialog)
END_MESSAGE_MAP()

Compilation::Compilation(CWnd* pParent,bool show)
            :CDialog(Compilation::IDD, pParent)
            ,m_max(100)
            ,m_current(0)
{
...
void 
Compilation::DoDataExchange(CDataExchange* pDX)
{
...
void
Compilation::SetCurrent(int p_current)
{
...
void
Compilation::SetText(CString p_text)
{
  m_text = p_text;
  MakeTextToShow();
  UpdateData(false);
